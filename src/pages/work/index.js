...
const WorkIndexPage = () => (
  <Layout width="wide">
    ...
    <StyledContainer>
      ...
      <div>
        <p>
          ...
          developer to build this website summarizing the year's accomplishments.
        </p>
    ...
    <StyledContainer>
      ...
      <div>
        <p>
          Teamed up with another software developer to make this website,
          which showcases some incredibly moving videography from the team at{` `}
