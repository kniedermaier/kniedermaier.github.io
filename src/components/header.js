...
const activeStyles = (width=1) => ({
  backgroundImage: "linear-gradient(to top, rgba(0,0,0,0) 11%, rgba(33,101,63, 0.9) 8%, rgba(33,101,63, 0.9) 15%, rgba(0,0,0,0) 16%)"
});
...
const Header = ({ siteTitle }) => {
  ...
  return(
    <StyledHeader>
      ...
      <StyledMenuHeading
        as="h2"
        onClick={toggleMenuOptionsVisible}
      >
        Menu
      </StyledMenuHeading>
      {
